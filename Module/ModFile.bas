...
Public Function FileDialog(FormObject As Form, SaveDialog As Boolean, ByVal Title As String, ByVal Filter As String, Optional ByVal Filename As String, Optional ByVal Extention As String, Optional ByVal InitDir As String) As String
    ...
    If Len(Filename) > MAX_PATH Then Call MsgBox("파일 길이가 너무 깁니다", vbExclamation, App.Title + " - FileDialog Function"): Exit Function
...
Public Function FileTitleOnly(Filename As String, Optional ReturnDirectory As Boolean) As String
    ...
    End If
End Function
Public Function Fileset(Optional ByVal Filename As String) As String
Fileset = Filename
End Function
...
Fail:
Call MsgBox(IIf(Err.Number = 0, "", "오류 " + CStr(Err.Number) + ": " + Err.Description + vbCrLf) + "경로를 만들거나 엑세스할 수 없습니다 :" + vbCrLf + vbCrLf + Chr$(34) + Path + Chr$(34), vbExclamation, App.Title + " - CreatePath Function")
